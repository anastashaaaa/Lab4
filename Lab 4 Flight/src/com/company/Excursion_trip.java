...
public class Excursion_trip extends Hotel {
    ...
    {
        String fileName = "D://Lab 4 Flight//Bus Countries//" + ticket.getCountry() + "//hotels.txt";
        try(FileInputStream fin = new FileInputStream(fileName)){
            int i = -1, j = 0;
            while((char)(i = fin.read())!= '_')
            {
    ...
    {
        String fileName = "D://Lab 4 Flight//Bus Countries//" + ticket.getCountry() + "//cities.txt";
        try(FileInputStream fin = new FileInputStream(fileName))
        {
            int i = -1,j = 0;
            while((char)(i = fin.read())!= '_'){
    ...
    {
        try(FileInputStream fin = new FileInputStream("D://Lab 4 Flight//Bus Countries//countries_list.txt")){
            int i=-1;
            while((char)(i = fin.read())!= '_'){
                System.out.print(((char)i));
            }
